...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New OrderDetails</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{orderDetails.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{orderDetails.create}" value="Create"/>
                <br />
                <br />
