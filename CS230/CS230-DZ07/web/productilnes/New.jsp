...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Productilnes</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{productilnes.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{productilnes.create}" value="Create"/>
                <br />
                <br />
